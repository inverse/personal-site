...
Out of the box the nvidia GPU drivers are not installed. You can use the default nivdia drivers outlined in the "Additional drivers" settings. I recommend installing `nvidia-prime` too as it'll enable you to switch between the Intel and Nvidia GPU easily from within unity.
