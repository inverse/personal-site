...
Out of the books the nvidia GPU drivers are not installed. You can use the default nivdia drivers outlined in the "Additional drivers" settings but I had more luck with the `nvidia-367` series.
